...
final class Version20230219094518 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT NOT NULL, author_id_id INT NOT NULL, post_id_id INT NOT NULL, create_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL DEFAULT NOW(), text TEXT NOT NULL, PRIMARY KEY(id))');
